...
public class PastPredictor
{
	...
	public synchronized long prevMatchingTime()
	{
		...
		for (int k = 0; k < size; k++)
		{
			...
			// Gets the matchers.
			ValueMatcher minuteMatcher = (ValueMatcher) _schedulingPattern.minuteMatchers.get(k);
			ValueMatcher hourMatcher = (ValueMatcher) _schedulingPattern.hourMatchers.get(k);
