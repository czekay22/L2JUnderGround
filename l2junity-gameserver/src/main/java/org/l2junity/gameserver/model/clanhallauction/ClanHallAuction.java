...
public class ClanHallAuction
{
	...
	private final void loadBidder()
	{
		...
		{
			LOGGER.warn("Failed loading clan hall auctions bidder for clan hall {0}.", _clanHallId, e);
		}
	}
	...
	public void addBid(L2Clan clan, long bid, long bidTime)
	{
		...
		{
			LOGGER.warn("Failed insert clan hall auctions bidder {} for clan hall {0}.", clan.getName(), _clanHallId, e);
		}
	}
	...
	public void removeBid(L2Clan clan)
	{
		...
		{
			LOGGER.error("Failed clearing bidder {} for clan hall {0}: ", clan.getName(), _clanHallId, e);
		}
	}
	...
	public void finalizeAuctions()
	{
		...
		if (potentialHighestBidder.isPresent())
		{
			...
			{
				LOGGER.error("Failed clearing bidder for clan hall {0}: ", _clanHallId, e);
			}
		}
	}
